...
public class RealmsReconnectStrategy extends ReconnectStrategy {
    ...
    public void reconnect() {
        ...
        RealmsPrepareConnectionTask task = new RealmsPrepareConnectionTask(titleScreen, realmsServer);
        MinecraftClient.getInstance().setScreen(new RealmsLongRunningMcoTaskScreen(titleScreen, task));
    }
}
